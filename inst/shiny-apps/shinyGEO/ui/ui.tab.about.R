  ...
  <div class='panel-heading'>
   ...
   <div class='panel-body'>
    ...
    <p> <span style = \'font-weight: bold\'> Jasmine Dumas </span>
         is a Data Scientist at Simple Finance and developer of <a href = 'https://cran.r-project.org/package=ttbbeer'> <code>ttbbeer</code> </a> and
          <a href = 'https://cran.r-project.org/package=shinyLP'> <code>shinyLP</code> </a>.
         ...
         <a href ='http://jasdumas.github.io/'>Jasmine's Homepage and blog</a> <span class= \'label label-primary\'>Contributor</span> </p>
