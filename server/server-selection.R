createAlert(session,"selectionAlert1",content = "<H4>Directions</H4><p> Select a subset of samples to analyze by specifying selection criteria using the drop down boxes below. Only samples matching all selection criteria will be included <br> For more advanced selection criteria, and to restore the sample data table, click on the 'Advanced Selection' tab</br></p>", dismiss=FALSE) 
...
shinyjs::onclick("btnSelection", {
 ...
 if (!is.null(sel2)) {
  ...
  content = paste0("<H4>Selection Criteria Applied (", sum(keep), " samples selected)</H4><p>", sel1, "<p>",
	           "To clear selection criteria, select 'Reset' under the 'Advanced Selection' tab</br>" ) 
